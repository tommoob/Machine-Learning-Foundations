...
def main():
    ...
    if not load_parameters:
        w, b = train_logistic_models(learn_rate=0.05, nepochs=50)
    ...
    precisions, recalls, total_precision, total_recall = calculate_precision_recall(stats)
...
def calculate_precision_recall(stats):
    ...
    total_precision = precision_sum / len(cats)
    total_recall = recall_sum / len(cats)
